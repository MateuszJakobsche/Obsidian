|**PROCES**|**WĄTEK**|
|---|---|
|- jest to wykonanie określonego *programu*|- części programu wykonywane współbieżnie w obrębie *procesu*|
|- *nie* współdzielą między sobą danych|- *współdzielą* między sobą dane (przestrzeń adresową)|
